...
class Venue(User):
    venueid = models.CharField(max_length=30)
 
    class Meta:
        verbose_name = 'Venue Admin'
 
class Performer(User):
    performer_id = models.CharField(max_length=30)
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    username = models.CharField(
        ...
        max_length=30,
        unique=True,
        help_text=_('Required. 30 characters or fe


        wer. Letters, digits and @/./+/-/_ only.'),
        validators=[validators.RegexValidator(r'^[\w.@+-]+$', _('Enter a valid username.'), 'invalid')]
    )
