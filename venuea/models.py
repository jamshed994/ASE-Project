...
class Venuea(User):
    venueid = models.CharField(max_length=30, unique=True)
    ...
    # venuea_name = models.CharField(_('venuea_name'), max_length=30, blank=True)
    # size = models.CharField(_('size string'), max_length=30, blank=True)
    # address = models.CharField(_('address string'), max_length=30, blank=True)
